...
import { ArrowLeft, Play, Globe, Lock, ChevronUp, ChevronDown } from "lucide-react";
      ...
      {roadmap && (
        <div className="fixed inset-0 bg-background overflow-hidden">
          ...
          <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-50">
            <Card className={`shadow-lg bg-background/95 backdrop-blur-sm transition-all duration-300 ${isHeaderMinimized ? 'px-4 py-2' : 'px-6 py-3'}`}>
              <div className="relative">
                <Button
                  variant="ghost"
                  size="icon"
                  className="absolute -right-2 -top-2 h-6 w-6 rounded-full opacity-50 hover:opacity-100"
                ...
                {isHeaderMinimized ? (
                  <div className="flex items-center gap-2 pr-4">
                    <h1 className="font-bold text-sm truncate max-w-[200px]">{roadmap.title}</h1>
