...
export default function GenerateClient({ user: _user, credits }: GenerateClientProps) {
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col gap-4 mb-8 items-center">
                <div className="bg-muted/50 p-4 rounded-lg flex items-center gap-4 justify-between max-w-md w-full border border-border">
                    ...
                    <ProductsList user={_user} trigger={<Button size="sm" variant="outline">Add Credits</Button>} />
                </div>
